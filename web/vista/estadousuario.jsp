...
<html>
    <head>
        ...
        <script src="../js/validarEstadoUsuario.js"></script>
    ...
    <body style="background-image: url('../imagenes/ropaRosada (1).jpg')" onload="visualizaOculta('<%=request.getParameter("Vista")%>');">
        ...
        <div id="Registrar" class="bd-example d-none">
            <div class="container" style="background-color: white">
                ...
                <form action="/vigiwebB/resgistrarEstadoUsuario" method="post" onsubmit="return validarEstadoUsuario()" >
                    <div class="form-row" >
                        <div class="form-group col-md-12" >
                            <h2>Estado usuario:</h2>
                            <input type="text" name="descrip_estado" class="form-control" placeholder="Digite el estado del usuario" id="txt_descrip_estado_Reg">
                        </div> 
                    </div>
        ...
        <div id="Listado" class="bd-example contenedor2">
            <form action="/vigiwebB/GestionEstadoUsuario" method="post">
                <div class="row justify-content-md-center">
                    ...
                    <div>
                        <h2 class="title-table">Listado Estado Usuarios</h2>
                        <%
                            estadoUsuarioDAO estadousuariodao = new estadoUsuarioDAO();
                            ArrayList<estado_usuario> estado_usuarioList = new ArrayList<estado_usuario>();
                            estado_usuarioList = estadousuariodao.ConsultarListadoEstadoUsuario(' ', buscando);
                            out.println("<table class='table table-light table-striped table-hover table-borderless border-dark'><thead class='thead-info'><tr><th>ID</th><th>Estado Usuario</th><th>Eliminar</th></tr></thead>");

                            for (estado_usuario C : estado_usuarioList) {

                                out.println("<tr>");
                                out.println("<td>" + C.getId_estado_usuario() + "</td>");
                                out.println("<td>" + C.getDescrip_estado() + "</td>");

                                out.println("<td>" + "<input type = 'submit' class='btn btn-danger btn btn-login' value='Eliminar'name='Eliminar'onclick='SetIdConsulta(" + C.getId_estado_usuario() + ")'/>" + "</td>");
                                out.println("</tr>");
                            }
                            out.println("</table>");
                        %>
