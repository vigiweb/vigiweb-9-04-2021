function validarEstadoUsuario() {
    ...
    var EstadoUsuario = document.getElementById("txt_descrip_estado_Reg").value;
...
function realizarBusqueda() {
    ...
    window.location.href = '/vigiwebB/vista/estadousuario.jsp?buscando=' + textoBuscado.trim() + '&';
}
