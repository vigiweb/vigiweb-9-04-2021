 ...
 * @author Famil
 */
@WebServlet(name = "registrarEstadoArticulo", urlPatterns = {"/registrarEstadoArticulo"})
public class registrarEstadoArticulo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String estado_articulo = request.getParameter("descrip_estado");
        ...
        if (BanderaEstado.equals("Correcto")) {
            String respuestaRegistrada = mi_estado_articulo_dao.AdicionarEstadoArticulo(mi_estado_articulo);
            System.out.println("Res " + respuestaRegistrada);
            System.out.println("Res " + respuestaRegistrada.length());
            if (respuestaRegistrada.length() == 0) {
                out.println("<script type=\"text/javascript\">");
                out.println("alert('" + "Estado Artículo registrado con éxito." + "');");
