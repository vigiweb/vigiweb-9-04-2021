...
public class registrarTipoMov extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String tipo_usuario = request.getParameter("m_descrip");
        String BanderaEstado = request.getParameter("BanderaRegistro");
        
        tipoMovDAO tmdao = new tipoMovDAO();
        tipo_mov tm = new tipo_mov();
        
        tm.setM_descrip(tipo_usuario);
        
        System.out.println("El valor es " + BanderaEstado);
        if (BanderaEstado.equals("Correcto")) {
            String respuestaRegistrada = tmdao.AdicionarMovimiento(tm);
            System.out.println("Res " + respuestaRegistrada);
            System.out.println("Res " + respuestaRegistrada.length());
            if (respuestaRegistrada.length() == 0) {
                out.println("<script type=\"text/javascript\">");
                out.println("alert('" + "Tipo Movimiento registrado con éxito." + "');");
