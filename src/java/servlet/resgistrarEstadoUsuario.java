 ...
 * @author Famil
 */
@WebServlet(name = "resgistrarEstadoUsuario", urlPatterns = {"/resgistrarEstadoUsuario"})
public class resgistrarEstadoUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String EstadoUsuario = request.getParameter("descrip_estado");
        String BanderaEstado = request.getParameter("BanderaRegistro");
        
        estadoUsuarioDAO eudao = new estadoUsuarioDAO();
        estado_usuario eu = new estado_usuario();
        
        eu.setDescrip_estado(EstadoUsuario);
        
        System.out.println("El valor es " + BanderaEstado);
        if (BanderaEstado.equals("Correcto")) {
            String respuestaRegistrada = eudao.AdicionarEstadoUsuario(eu);
