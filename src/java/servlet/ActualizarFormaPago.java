 ...
 * @author diego
 */
@WebServlet(name = "ActualizarFormaPago", urlPatterns = {"/ActualizarFormaPago"})
public class ActualizarFormaPago extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("Número de documento " + referenciapago);
        String respuestaRegistrada = odao.Actualizarforma_pago(o);
