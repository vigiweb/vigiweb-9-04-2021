 ...
 * @author Famil
 */
@WebServlet(name = "actualizarArticulos", urlPatterns = {"/actualizarArticulos"})
public class actualizarArticulos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("Número de documento " + referencia_articulo);
        String respuestaRegistrada = mi_articulo_dao.ActualizarArticulo(mi_articulo);
