 ...
 * @author Famil
 */
@WebServlet(name = "registrarProveedores", urlPatterns = {"/registrarProveedores"})
public class registrarProveedores extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String pr_identificacion = request.getParameter("pr_identificacion");
        ...
        if (BanderaEstado.equals("Correcto")) {
            ...
            if (respuestaRegistrada.length() == 0) {
                ...
                out.println("alert('" + "Proveedor Registrado con éxito." + "');");
