...
public class GestionCiudades extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Ciudad = miciudaddao.ConsultarUsuario(Identificacion);

            if (Accion != null) {

                if (Ciudad != null) {

                    response.sendRedirect("/vigiwebB/vista/ciudades.jsp?Ciudad=" + Ciudad.getDescrip_ciudad() + "&"
                ...
                if (Ciudad != null) {
                    ...
                    String respuestaRegistrada = miciudaddao.EliminarCiudad(Ciudad);
