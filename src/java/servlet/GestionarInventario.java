 ...
 * @author diego
 */
@WebServlet(name = "GestionarInventario", urlPatterns = {"/GestionarInventario"})
public class GestionarInventario extends HttpServlet {
           ...
           String Accion = request.getParameter("Actualizar");
            ...
            if (Accion != null) {
                ...
                if (Inventario != null) {
                    ...
                    response.sendRedirect("/vigiwebB/vista/inventario.jsp?Entrada=" + Inventario.getIn_entradas() + "&"
                            + "Salida=" + Inventario.getIn_salidas() + "&"
                            + "Saldo=" + Inventario.getIn_saldo() + "&"
                            + "Vista=" + "Actualizar" + "&");
