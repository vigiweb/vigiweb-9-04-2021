    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                mi_usuario = mi_usuario_dao.ConsultarUsuario(Usuario);
                
                if (mi_usuario == null) {
                    System.out.println(Usuario);
                    out.println("<script type=\"text/javascript\">");
                    out.println("alert('" + "La identificación  " + Usuario + ", no existe." + "');");
                    ...
                    if (mi_usuario.getContraseña().equals(Clave)) {
                        ...
                        out.println("<script type=\"text/javascript\">");
                        out.println("alert('" + "La clave digitada es incorrecta" + "');");
                        out.println("window.location.href ='inicioSesion.jsp';");
                        out.println("</script>");
                    }
                }
                ...
                out.println("<script type=\"text/javascript\">");
                out.println("alert('" + "El usuario ingresado debe ser numérico : " + Usuario + "');");
                out.println("</script>");
            }
        }
    }
