...
public class pruebaConsultarListaArticulos {
    ...
    public static void main(String[] args) {
        ...
        mi_articulo = articulo_dao.ConsultarListadoArticulos("", "");
        
        int size = mi_articulo.size();
        System.out.println("<table border=\"1\"><tr><td>id_articulo</td><td>nombre_articulo</td><td>referencia_articulo</td><td>precio_articulo</td><td>cantidad_articulo</td><td>iva_articulo</td><td>descripcion_articulo</td> "
                + " <td>estado_articulo</td><td>proveedor_id_proveedor</td> ");
        ...
        for(articulo A: mi_articulo){
            ...
            System.out.println("<td>" + A.getReferencia_articulo() + "</td>");
